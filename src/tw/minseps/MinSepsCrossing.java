...
//    System.out.println(minimalSeparators.size() + " total min seps");
  }
...
//      assert isMinimalSeparator(sFixed);
    ...
    if ((nd > (width - ns) && 
      ...
      int depth = 1;
      //    System.out.println(indent + "xmas check");
      assert width > ns;
      while (true) {
      ...
      //    System.out.println(indent + "xmas check ending");
    ...
    //  XBitSet undecided = (XBitSet) toCross.clone();
    //  undecided.andNot(aFixed);
    //  undecided.andNot(sFixed);
    //
    //  int v = toDecide.nextSetBit(0);
    //  if (!undecided.isEmpty()) {
    //    while (!undecided.intersects(toDecide)) {
    //      undecided = g.closedNeighborSet(undecided);
    //    }
    //    v = undecided.intersectWith(toDecide).nextSetBit(0);
    //  }
