...
//    double p = choose(1, 0.1) + log23 * 0.9;
...
//              continue;
//            }
            for (int ic = ia - 3 * ik / 2; ic <=  ia - ib; ic += 10) {
              ...
              if (v > max) {
                ...
                System.out.println("  new max " + max + " at k " + k + 
                    " e == e1 " + (e == e1) + " e1 " + e1 + " e2 " + e2 + " a " + a + " b " + b + " c " + c +
                    " log23 a " + log23 * a + 
        ...
        if (max > globalMax) {
          globalMax = max;
          System.out.println("new global max " + globalMax + " k " + k);
        }
      }
    }
  }
  ...
  static void calc12() {
    ...
    for (int ik = 1; ik <= 666; ik += 10) {
      double k = toDouble(ik);
//      for (int is = 1; is <= ik * 3 / 2; is+= 10) {
      for (int is = ik * 3 / 2; is <= ik * 3 / 2; is+= 10) {
        double s = toDouble(is);

        System.out.println( " k = " + k + " s = " + s +
            " choose(1, s) " + choose(1, s) + 
//            " log_2 3 4(1 - s)/5 " + log23 * 4 * (1 - s) / 5);
        " log_2 3 (1 - s) " + log23 * (1 - s));
//        double v1 = Math.pow(2.0,  choose(1, s) + log23 * 4 * (1 - s) / 5);
        double v1 = Math.pow(2.0,  choose(1, s) + log23 * Math.min(s, 1 - s));
...
//                a - b > (2.0 / 3.0)) {
            ...
            for (int ic = ia - 3 * ik / 2; ic <=  ia - ib; ic += 10) {
              ...
              if (v > max) {
                max = v;
                System.out.println("  new max " + max + " at k " + k + " s " + s +
        ...
        if (v > globalMax) {
          globalMax = v;
          System.out.println("new global max " + globalMax + " k " + k + " s " + s);
        }
      }
    }
  }
