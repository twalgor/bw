...
public class Algorithm2 {
  ...
  public void decompose() {
    if (g.isStar()) {
      ...
      if (v0 == g.n) {
        BlockDP0 bldp = new BlockDP0(g);
//        BlockDP bldp = new BlockDP(g);
        bldp.decompose();
        width = bldp.k;
      ...
      Algorithm2 bw = new Algorithm2(sub.h);
      bw.decompose();
      width = bw.width;
      if (width == 1) {
        width = 2;
...
//      String instanceName = "KrackhardtKiteGraph";
      String instanceName = "SchlaefliGraph";
